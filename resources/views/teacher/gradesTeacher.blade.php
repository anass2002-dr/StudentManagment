...
@section('titel','Manages Grades Teacher')
@section('content')
<div class="container body_student">
    <div class="rounded row_content">
        ...
        <div class="row m-3">
            ...
            <div class="col-lg-2 py-5 position-relative">
               <a href="{{route('home.createGrades')}}" class="position-absolute end-0">Create New list</a>
            </div>
        </div>
