...
<section>
    ...
    <div class="col-md-6 col-lg-4 mb-4">
      ...
      <div class="col-12">
        <form action="" style="max-width: 500px; margin:auto;margin-top:25px;margin-right:30px">
            <div class="py-3">
                <input type="email" name="email" id="email" placeholder="Email" class="form-control">
            </div>
            <div>
                <textarea name="messege" id="messege" placeholder="Messege" cols="30" rows="7" class="form-control"></textarea>
            </div>
            <div class="py-3">
                <input type="submit" value="Send" class="btn btn-primary" style="">
            </div>
        </form>
      </div>
    </div>
