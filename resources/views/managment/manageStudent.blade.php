...
@section('titel','Manages Student User')
@section('content')
        ...
        <div class="row m-3 border p-2 rounded bg-light py-3">
            ...
            <div class="col-lg-2" style="padding-top: 40px; ">
                <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modal_add_user">
                    Add new Student</button>                {{-- <a href="#" class="position-absolute end-0">Create New Student User</a> --}}
             </div>
        </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-titel" id="modal_add_user_lb">Add New Student User</h5>
                    <button  type="button" class="btn-close" data-bs-dismiss="modal" ></button>
                </div>
                <div class="modal-body">
                    <form method="POST" action="{{route('home.add_student')}}">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <input type="text" name="p_code" id="" class="form-control" required placeholder="Parent Code">
                        </div>
                        <div class="mb-3">
