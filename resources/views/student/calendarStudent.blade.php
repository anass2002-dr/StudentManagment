...
@section('titel','Calendar Student')
@section('content')
<div class="container" >
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="col">wevwerv</td>
                        <td class="col">wevwerv</td>
                        <td class="col">ervewrv</td>
                        <td class="col">evwev</td>
                        <td class="col">verwcv</td>
                        <td class="col">vweverv</td>
                        <td class="col">vrewver</td>
                    </tr>
                    <tr>
