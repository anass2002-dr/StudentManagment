...
<body>
    <body id="body-pd">
        <header class="header" id="header">
            ...
            {{-- <a href="{{route('home.userStudent')}}" class="d-flex">
                <p class="m-2 text-muted">Anass Dermaj</p>
                <img src="/assets/img/mePNG.png" alt="" class="rounded-circle" width="40" height="40">
            </a> --}}
        ...
        <div class="l-navbar" id="nav-bar">
            <nav class="nav">
                <div>
                    <a href="{{route('home.homeStudent')}}" class="nav_logo active">
                         <i class='bx bx-layer nav_logo-icon'></i> <span class="nav_logo-name">My Schoole</span>
                    </a>
                    <div class="nav_list">
                        <a href="{{route('home.userStudent')}}" class="nav_link">
                            <i class='bx bx-user nav_icon'></i> <span class="nav_name">Users</span>
                       </a> 
                        <a href="{{route('home.calendarStudent')}}" class="nav_link"> 
                            <i class='bi-calendar-range'></i><span class="nav_name">Calendar</span>
                        </a>
                        <a href="{{route('home.gradesStudent')}}" class="nav_link"> 
                            <i class='bi bi-card-checklist nav_icon'></i> <span class="nav_name">Grades</span>
                        </a>
                        <a href="{{route('home.coursesStudent')}}" class="nav_link"> <i class='bx bx-book nav_icon'></i> 
                            <span class="nav_name">courses</span> 
                        </a> 
                        <a href="{{route('home.absenceStudent')}}" class="nav_link">
                            <i class='bi bi-x-circle nav_icon'></i> <span class="nav_name">Absence</span> 
                        </a> 
                        <a href="{{route('home.helpStudent')}}" class="nav_link">
